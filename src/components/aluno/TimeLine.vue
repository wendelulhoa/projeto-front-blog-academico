<template>
  <div class="container">
    <div class="page-header">
      <h1 id="timeline">Atividades</h1>
    </div>
    <ul class="timeline">
      <li class="timeline" v-for="(item, index) in atividade" :key="index">
        ...
        <div class="timeline-panel">
          <div class="timeline-heading">
            ...
            <p>
              <small class="text-muted">data limite: {{ item.data }}</small>
            </p>
          </div>
          <div class="timeline-body">
            ...
            <form @submit.prevent="send(item.id)" v-if="item.entrega == true" enctype="multipart/form-data" :name="item.id">
              ...
              <div class="pt-2 pb-3">
                ...
                <input type="text" name="cod" :value="item.id"  hidden>
...
export default {
  ...
  methods: {
    ...mapActions({
      changeAtividade: "changeAtividade",
    }),
    linkDown(link) {
      this.link = "http://localhost:8000/api/" + link;
    },
    send(id) {
